...
Since version `0.2.0` we use the new JWPlayerKit && SDK 4 check out [iOS SDK installation](https://developer.jwplayer.com/jwplayer/docs/ios-get-started) && [Android SDK installation](https://developer.jwplayer.com/jwplayer/docs/android-get-started)
