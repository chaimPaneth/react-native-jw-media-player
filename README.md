...
| **`onControlBarVisible`** | Callback when the controls are visible usually after touch on video. (doesn't work in android v4.x as per JW [docs](https://developer.jwplayer.com/sdk/android/reference/com/longtailvideo/jwplayer/events/listeners/VideoPlayerEvents.OnControlBarVisibilityListener.html).) | `{controls: Boolean}`                                                                                                                                                                                                                                                                                                           |
...
For setting a custom style on the player:
  ...
  2. Put your custom css file on `ios` in the root folder of your native files and on `android` in the `app/src/main/assets` folder.
